...
import { AmbientTrafficBackdrop } from './components/AmbientTrafficBackdrop'
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        <Routes>
          ...
          <Route element={<PrivateRoute><Layout /></PrivateRoute>}>
            ...
            <Route path="/admin/zonas/:zonaId/editor" element={<AdminRoute><EditorMapa /></AdminRoute>} />

            {/* Operador */}
            <Route path="/operador" element={<OperadorRoute><OperadorDashboard /></OperadorRoute>} />
            <Route path="/operador/zonas" element={<OperadorRoute><OperadorZonas /></OperadorRoute>} />
            <Route path="/operador/zonas/:zonaId/editor" element={<OperadorRoute><OperadorEditorMapa /></OperadorRoute>} />
          </Route>
