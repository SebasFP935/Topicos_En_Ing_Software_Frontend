...
const SLOT_ITEMS = [
  { x: 160, y: 170, w: 92, h: 58, color: '#0068b7', delay: 0 },
  { x: 282, y: 154, w: 92, h: 58, color: '#7ba5ff', delay: 0.5 },
  { x: 404, y: 138, w: 92, h: 58, color: '#8d6bff', delay: 1.2 },
  { x: 526, y: 122, w: 92, h: 58, color: '#ffcc00', delay: 0.9 },
  { x: 682, y: 260, w: 92, h: 58, color: '#7ba5ff', delay: 1.5 },
  { x: 804, y: 244, w: 92, h: 58, color: '#0068b7', delay: 0.2 },
  { x: 926, y: 228, w: 92, h: 58, color: '#8d6bff', delay: 0.8 },
]

const TRAFFIC_PATHS = [
  { id: 'atb-p1', color: '#0068b7', duration: 14, delay: -1.8, d: 'M -120 330 C 240 252, 620 232, 1320 140' },
  ...
  { id: 'atb-p4', color: '#ffcc00', duration: 20, delay: -9.5, d: 'M 1320 604 C 840 538, 402 538, -120 666' },
...
const AMBIENT_CSS = `
  ...
  .atb-glow {
    ...
    inset: -10%;
    background:
      radial-gradient(circle at 12% 16%, rgba(0,104,183,.28), transparent 32%),
      ...
      radial-gradient(circle at 24% 82%, rgba(255,204,0,.16), transparent 32%);
