  ...
  return (
    <NavLink
      ...
      style={({ isActive }) => ({
        ...
        background: isActive
          ? 'linear-gradient(125deg, rgba(0,104,183,.25), rgba(0,104,183,.1) 46%, rgba(123,165,255,.16))'
          : 'rgba(255,255,255,.015)',
        border: `1px solid ${isActive ? 'rgba(0,104,183,.55)' : 'rgba(255,255,255,.05)'}`,
...
export function Sidebar() {
  ...
  return (
    <aside style={{
      width: 284,
      height: '100dvh',
      background: 'radial-gradient(circle at 5% 0%, rgba(0,104,183,.16), transparent 26%), radial-gradient(circle at 96% 6%, rgba(123,165,255,.12), transparent 24%), linear-gradient(180deg, rgba(5,8,12,.98), rgba(7,10,15,.9))',
      ...
      <div style={{ padding: '4px 12px 20px', display: 'flex', alignItems: 'center', gap: 11 }}>
        <div style={{ width: 44, height: 44, borderRadius: 14, background: GRAD, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, boxShadow: '0 10px 26px rgba(0,104,183,.30)' }}>
